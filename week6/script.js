...
//     myTitle.textContext = myImg.dataset.catname;
...
//              item.classList.add("purple-box");
//         }
//          else if (item.dataset.topic==="sounds")
//          {
...
console.log(myHeading);
myHeading.innerHTML = `new <span class="coral-box"> ${courseName} ,

// myHeading.textContext = "new heading";
